...
export const products: Product[] = [
  ...
  {
    id: 16,
    name: "Hạt Hướng Dương Tươi",
    slug: "hat-huong-duong",
    category: "food",
    price: 35000,
    image: "https://placehold.co/400x400/FCE7F3/9D174D?text=Sunflower",
    description: "Hạt hướng dương tươi ngon, giàu dinh dưỡng, hamster rất thích.",
    stock: 45,
    rating: 4.9,
    reviewCount: 35,
    featured: true,
