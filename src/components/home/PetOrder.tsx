...
const petTypes = [
  { icon: Rabbit, name: "Thỏ Việt", color: "from-pink-400 to-rose-500", bg: "bg-pink-50", image: "/NKHamster/thoviet.webp" },
  { icon: Bug, name: "Bọ Ú Việt", color: "from-amber-400 to-orange-500", bg: "bg-amber-50", image: "/NKHamster/bou.webp" },
  { icon: Bird, name: "Nhím Cảnh", color: "from-stone-400 to-stone-600", bg: "bg-stone-50", image: "/NKHamster/nhimcanh.jpg" },
  { icon: Dog, name: "Sóc Bay", color: "from-sky-400 to-blue-500", bg: "bg-sky-50", image: "/NKHamster/socbay.webp" },
  { icon: Fish, name: "Thằn Lằn", color: "from-lime-400 to-green-500", bg: "bg-lime-50", image: "/NKHamster/thanlan.jpg" },
  { icon: DragonIcon, name: "Rồng Úc", color: "from-emerald-400 to-teal-500", bg: "bg-emerald-50", image: "/NKHamster/ronguc.jpg" },
];
