...
export const products: Product[] = [
  ...
  },
  {
    ...
    stock: 10,
    variants: [
      { label: "Nhà Ngủ gỗ cà rốt", price: 100000, wheelDetails: [{ size: "15x12x10", price: "100.000đ" }] },
      { label: "Nhà Ngủ gỗ bụi cây", price: 200000, wheelDetails: [{ size: "20x12x18", price: "200.000đ" }] },
      { label: "Nhà Ngủ gỗ yêu tinh", price: 160000, priceLabel: "160.000đ - 180.000đ", wheelDetails: [
        { size: "nhỏ 15x11x18", price: "160.000đ" }, { size: "lớn 17x11x20", price: "180.000đ" },
      ] },
      { label: "Nhà Ngủ gỗ tiên", price: 160000, wheelDetails: [{ size: "15x11x18", price: "160.000đ" }] },
      { label: "Nhà Ngủ gỗ nhím", price: 100000, wheelDetails: [{ size: "15x12x10", price: "100.000đ" }] },
      { label: "Nhà Ngủ gỗ chuột hamster", price: 100000, wheelDetails: [{ size: "15x12x10", price: "100.000đ" }] },
      { label: "Nhà Ngủ gỗ hạt dẻ", price: 100000, wheelDetails: [{ size: "15x12x10", price: "100.000đ" }] },
      { label: "Nhà Ngủ gỗ hạt dâu", price: 100000, wheelDetails: [{ size: "15x12x10", price: "100.000đ" }] },
      { label: "Nhà Ngủ gỗ xương rồng", price: 100000, wheelDetails: [{ size: "15x12x10", price: "100.000đ" }] },
      { label: "Nhà Ngủ gỗ cừu", price: 100000, wheelDetails: [{ size: "15x12x10", price: "100.000đ" }] },
      { label: "Nhà Ngủ gỗ song sinh", price: 200000, wheelDetails: [{ size: "18x12x15", price: "200.000đ" }] },
    ],
  },
  {
    id: 14,
