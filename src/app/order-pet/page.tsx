...
const orderPets = [
  ...
  { name: "Bọ Việt", emoji: "🐛", image: "/NKHamster/bo-viet.webp", price: "200.000đ – 800.000đ", description: "Bọ que Việt Nam, sinh vật độc đáo và lạ mắt, rất dễ nuôi.", traits: ["Ăn lá cây", "Thân thiện", "Ít tốn kém"] },
