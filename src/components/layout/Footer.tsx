      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
        ...
        <div className="col-span-2 md:col-span-1">
          ...
          <div className="flex gap-1">
            ...
            <a href="https://tiktok.com/@nkhamster" target="_blank" rel="noopener noreferrer" className="w-7 h-7 rounded-lg bg-white/5 hover:bg-primary-500/20 flex items-center justify-center transition-all duration-300" aria-label="TikTok">
              <svg className="h-3.5 w-3.5 text-gray-500 hover:text-primary-400" viewBox="0 0 24 24" fill="currentColor">
